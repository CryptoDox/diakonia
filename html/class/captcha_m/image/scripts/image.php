...
class Captcha_mImageHandler
{
    ...
    {
        xoops_load('Captcha_m');
        $this->captcha_handler = Captcha_m::getInstance();
        $this->config = $this->captcha_handler->loadConfig("image");
    }

    function Captcha_mImageHandler()
    {
        $this->__construct();
    }
...
$image_handler = new Captcha_mImageHandler();
