 ...
 * @version     $Id: xoopsload.php 4897 2010-06-19 02:55:48Z phppp $
...
class XoopsLoad
{
    ...
    function loadCoreConfig()
    {
        return $configs = array(
			...
			//'xoopsmo_captcha' => XOOPS_ROOT_PATH . '/class/mo_captcha/xoopsmo_captcha.php',
            'xoopscaptcha' => XOOPS_ROOT_PATH . '/class/mocaptcha/mocaptcha.php',
			...
			'xoopsformmocaptcha' => XOOPS_ROOT_PATH . '/class/xoopsform/formmo_captcha.php',
