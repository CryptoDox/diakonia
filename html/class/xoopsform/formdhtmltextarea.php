 ...
 * @version         $Id: formdhtmltextarea.php 4897 2010-06-19 02:55:48Z phppp $
 */
...
class XoopsFormDhtmlTextArea extends XoopsFormTextArea
{
    ...
    function render()
    {
        ...
        if (empty($this->skipPreview)) {
            ...
            $button = // "<br />" .
"<input " . "   id='" . $this->getName() . "_preview_button'" . "   type='button' " . "   value='" . _PREVIEW . "' " . "   onclick=\"form_instantPreview('" . XOOPS_URL . "', '" . $this->getName() . "','" . XOOPS_URL . "/images', " . intval($this->doHtml) . ")\"" . " />";
