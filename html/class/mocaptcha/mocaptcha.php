 ...
 * @version         $Id: xoopscaptcha.php 4897 2010-06-19 02:55:48Z phppp $
 */
...
class XoopsCaptcha
{
    ...
    function __construct()
    {
        ...
        $this->path_basic = XOOPS_ROOT_PATH . '/class/mocaptcha';
        $this->path_plugin = XOOPS_ROOT_PATH . '/class/mocaptcha';
    ...
    {
        $config = false;
        $filename = empty($filename) ? 'moconfig.php' : 'moconfig.' . $filename . '.php';
    ...
    function loadHandler($name = null)
    {
        ...
        $this->handler = null;
        if (file_exists($file = $this->path_basic . '/' . $prefix . $name . '.php')) {
            include_once $file;
        } else {
            if (file_exists($file = $this->path_plugin . '/' . $prefix . $name . '.php')) {
                include_once $file;
            }
        }
        if (!class_exists($class)) {
            $class = 'text';
            require_once $this->path_basic . '/motext.php';
        }
