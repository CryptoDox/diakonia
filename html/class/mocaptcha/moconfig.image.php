 ...
 * @version         $Id: config.image.php 4897 2010-06-19 02:55:48Z phppp $
 */
...
return $config = array(
    ...
    'rootpath' => XOOPS_ROOT_PATH . '/class/mocaptcha/image',  // __Absolute__ Path to the root of fonts and backgrounds
    'imageurl' => 'class/mocaptcha/image/scripts/mo_image.php',  // Path to the script for creating image, __relative__ to XOOPS_ROOT_PATH
