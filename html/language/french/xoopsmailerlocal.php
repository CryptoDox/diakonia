...
class XoopsMailerLocal extends XoopsMailer
{
     ...
     */
        function XoopsMailerLocal() {
                $this->XoopsMailer();
                // Il n'est pas utile de changer le charset
                $this->charSet = strtolower( _CHARSET );
                // vous DEVEZ indiquer la valeur du code langage et que le fichier existe  : XOOPS_ROOT_PAT/class/mail/phpmailer/language/lang-["your-language-code"].php
