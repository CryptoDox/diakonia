...
define ('_NOT_ITEMURLNOTAVAILABLE', 'Lien de l\'élément non disponible');
...
define ('_NOT_CONFIG_ENABLEDDSC', 'Ce module permet aux '._FR_SPEC_USERS.' de choisir d\'être averti lorsque certains événements arrivent. Choisissez \'OUI\' pour permettre cette fonction.');
define ('_NOT_CONFIG_EVENTS', 'Activer les événements spécifiques');
define ('_NOT_CONFIG_EVENTSDSC', 'Choisissez les notifications d\'événements auxquels vos '._FR_SPEC_USERS.' peuvent souscrire.');
define ('_NOT_CONFIG_ENABLE', 'Activer la notification');
define ('_NOT_CONFIG_ENABLEDSC', 'Ce module permet aux '._FR_SPEC_USERS.' d\'être avertis lorsque certains événements se produisent. Choisissez si les '._FR_SPEC_USERS.' doivent être prévenus avec les options de notifications dans un bloc (Style Bloc), dans le module (Style Intégré), ou les deux. Pour la notification de style bloc, le bloc d\'options de notifications doit être activé pour ce module.');
...
define ('_NOT_COMMENTSUBMIT_NOTIFYCAP', 'Me prévenir lorsqu\'un nouveau commentaire est proposé (en attente d\'être approuvé) pour cet article.');
...
define ('_NOT_NOTIFYMETHOD', 'Méthode de notification : <br />Lorsque vous contrôlerez par exemple un forum, comment voulez-vous recevoir les notifications de mises à jour ?');
...
define ('_NOT_NOTHINGTODELETE', 'Il n\'y a rien à supprimer.');
