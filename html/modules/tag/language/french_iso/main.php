 ...
 * @since		1.00
 * @version		$Id: main.php 527 2009-08-03 16:49:29Z dugris $
 * @package		module::tag
 */
...
define("TAG_MD_JUMPTO", "Aller à la page de détail pour le tag");
define("TAG_MD_TAG_DELIMITER", "Les délimiteurs suivants sont valides pour les tags multiples");
define("TAG_MD_INVALID", "Requête non valide");
...
$GLOBALS["TAG_MD_ADDONS"] = array(
	"google"	=> array(
						"title"		=> "Google",
						"link"		=> "http://www.google.fr/search?q=%s",
						),	
	"techno"	=> array(
						"title"		=> "Technorati",
