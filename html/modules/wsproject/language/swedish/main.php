...
include_once(XOOPS_ROOT_PATH."/modules/wsproject/language/swedish/shared.php");


define("_WS_USERDETAILS","");

define("_WS_NOTE",			"Notering");
...
define("_WS_RESTORE",		"Återställ");
define("_WS_UPDATETASK",	"Uppdatera Uppgift");
define("_WS_UPDATEPROJECT",	"Uppdatera Projekt");
define("_WS_DELPROJECT1",	"Är du säker på att du vill radera");
...
define("_WS_CONFIG",		"Konfigurering");
define("_WS_USEDGROUPS",	"Använda grupper");
define("_WS_APPLY",			"Aktivera");

define("_WS_PROJECTUSER",	"Standard Användare");
define("_WS_PROJECTUSERNOTE","En uppgift kan tilldelas dessa användare och de kan själva uppdatera status informationen för sina uppgifter.");
define("_WS_PROJECTADMIN2",	"Administratörer");
define("_WS_PROJECTADMINNOTE","Användare med rättighet att<br />modifiera ALLA uppgifter.");
define("_WS_ADMINGROUPS",	"Administratörs grupper<br />Dessa användare kan modifiera<br /> ALLA uppgifter och projekt.");
?>