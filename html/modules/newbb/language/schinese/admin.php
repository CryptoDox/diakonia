...
define("_AM_NEWBB_POSTPERPAGE","主题每页显示帖子数:<span style='font-size: xx-small; font-weight: normal; display: block;'>(这是选择每一讨论主题，每页显示的帖子数)</span>");
define("_AM_NEWBB_TOPICPERFORUM","讨论区每页显示的主题数:<span style='font-size: xx-small; font-weight: normal; display: block;'>(这是选择讨论区每一页要显示几篇主题)</span>");
...
define("_AM_NEWBB_CAN_EDIT","可以编辑");
define("_AM_NEWBB_CAN_DELETE","可以删除");
