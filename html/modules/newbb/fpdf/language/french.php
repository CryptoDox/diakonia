<?php
// $Id: french.php 677 2009-08-20 15:58:21Z dugris $
//  ------------------------------------------------------------------------ //
...
define('NEWBB_PDF_TOPIC', 'Sujet');
define('NEWBB_PDF_SUBJECT', 'Objet');
...
class PDF_language extends FPDF
{
        ...
        function Error($msg)
        {
                ...
                if($pdf_config['action_on_error']){
                        //Fatal error
                        die('<strong>FPDF erreur : </strong>'.$msg);
                }
        }
 ...
 *
 * @version         $Id: french.php 677 2009-08-20 15:58:21Z dugris $
**/
?>