...
function Tools() {
    ...
    OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
echo " <CENTER><TABLE  cellSpacing=0 cellPadding=0 width=\"100%\">"
  . "  "
  . "  "
  . "    <TD class='odd' valign=top align=middle width=\"30%\" ><BR>"
  . "    <a href=\"index.php?func=HTMLPHP\">"._HTMLC."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=HTMLASP\">"._HTMLASP."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=HTMLJSP\">"._HTMLJSP."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=HTMLPERL\">"._HTMLPERL."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=HTMLJS\">"._HTMLJS."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=HTMLSWS\">"._HTMLSWS."</a></TD>"
  . "    <TD class='odd' valign=top align=middle width=\"30%\" ><BR>"
  . "    <a href=\"index.php?func=Module\">"._MODULEC."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=Block\">"._BLOCKC."</a> <br>"
  . "    &nbsp;<p>"
  . "    <br>"
  . "    ::&nbsp;&nbsp;HelpFiles&nbsp;&nbsp;::<br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=HelpModule\">"._MODHELP."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=HelpBlock\">"._BLKHELP."</a> "
  . "</TD></TR></TABLE>";
echo " <CENTER><TABLE  cellSpacing=0 cellPadding=0 width=\"100%\">"
  . "  "
  . "  "
  . "    <TD class='odd' valign=top align=middle width=\"30%\" ><BR>"
  . "    <a href=\"index.php?func=Source\">"._EDITORC."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=MTags\">"._METAC."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=Scroll\">"._SCROLLC."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=Pop\">"._POPUP."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=Color\">"._HEXC."</a> <br>"
  . "    <br>"
  . "    <a href=\"index.php?func=ColorMatch\">"._HEXV."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=PREVIEWER\">"._PREVIEWER."</a></TD>"
  . "    <TD class='odd' valign=top align=middle width=\"30%\" height=\"182\"><BR> "
  . "    <a href=\"index.php?func=SourceCoder\">"._SCODER."</a>"
  . "    <p>"
  . "    <a href=\"index.php?func=HTMLENCODER\">"._HTMLCODER."</a></p>"
  . "    <p>"
  . "    <a href=\"index.php?func=URLENCODER\">"._URLCODER."</a></p>"
  . "    <p>"
  . "    <a href=\"index.php?func=EMAIL\">"._EMAILCODER."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=ROT\">"._ROTCODER."</a> <br>"
  . "    <br>"
  . "     "
  . "    <a href=\"index.php?func=DeDupe\">"._DEDUPER."</a> <br>"
  . "</TD></TABLE>";
    echo "";
    OpenTable();
    echo ""._discopy."";
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._MODULEC);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/DisModule.js");
       OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
echo "<TABLE class=\"\" borderColor=blue cellspacing=0 cellPadding=0 width=\"100%\" border=0>"
  . "<TR><TD align=middle>"
  ...
  . "<TR><TD align=middle>"._PASTE."</TD></TR></TABLE>"
  . "<TABLE cellspacing=2 cellPadding=2 width=\"100%\" border=0><TR>"
  ...
  . "<TR><TD align=middle>&nbsp;</TD></TR></TABLE></TD></TR></TABLE></CENTER></TR></TABLE>";
echo"    <BR><BR><CENTER><a href=\"index.php?func=HelpModule\"><h5>"._HELP."</h5></a>";
    CloseTable();
    OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
  echo "";
    OpenTable();
    echo ""._discopy."";
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._BLOCKC);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/DisBlock.js");
    OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
echo " <TABLE cellspacing=0 cellPadding=0 width=\"100%\" border=0>"
  . "<TR><TD align=middle><CENTER>"
  . "<center><br><h4>"._BLOCKC."</h4><BR>"
  . "<TABLE borderColor=#aa0000 cellspacing=0 cellPadding=0 width=\"98%\" border=0>"
  . "<TR><TD><CENTER><FORM name=blocker>"
  ...
  . "</TD></TR></TABLE></CENTER></TR></TABLE>";
echo"    <BR><BR><CENTER><a href=\"index.php?func=HelpBlock\"><h5>"._HELP."</h5></a>";
    CloseTable();
    OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HTMLC);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/DisHTMLPHP.js");
        OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
echo " <TABLE borderColor=blue cellspacing=0 cellPadding=0 width=\"100%\" border=0>"
  . "<TR><TD><TABLE borderColor=blue cellspacing=0 cellPadding=0 width=\"100%\" border=0>"
  . "<TR><TD align=middle>"
  ...
  . "<TR><TD align=middle>"._PASTE."</TD></TR></TABLE>"
  . "<TABLE cellspacing=2 cellPadding=2 width=\"100%\" border=0>"
  . "<TR><TD align=middle><TEXTAREA name=input rows=15 wrap=VIRTUAL cols=68></TEXTAREA> "
  ...
  . "<INPUT class=button onclick=reset(input.output) type=button value="._CLEAR."> "
  . "</TD></TR></FORM></CENTER></TD></TR>"
  . "<TR></TR></TABLE></TD></TR></TABLE></CENTER></TD></TR></TABLE>";
    CloseTable();
    OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HTMLJS);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/DisHTMLJS.js");
        OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HTMLASP);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/DisHTMLASP.js");
        OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HTMLJSP);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/DisHTMLJSP.js");
    OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HTMLPERL);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/DisHTMLPERL.js");
        OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._EDITORC);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/Dis.js");
    OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._POPUP);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/popup.js");
    OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._SCROLLC);
...
echo " <center><td><br><h4>"._SCROLLC."</h4><BR>"
  ...
  . "</script>"
  . ""
  . "<div align=\"center\"><script language=\"JavaScript\" src='".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/js/iescroll.js'></script></div>";
    CloseTable();
    OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HEXC);
...
echo " <center><br><h4>"._HEXC."</h4><BR>"
  ...
  . "        <table width=\"90%\" border=\"1\" cellpadding=\"2\" cellspacing=\"0\" bordercolorlight=\"#787878\" bordercolordark=\"#787878\" style=\"border-collapse: collapse; border-color: #000\" bordercolor=\"#787878\">"
  . "        <tr align=\"center\">"
  . "        <td>Color & Name</td>"
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._METAC);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/DisMTags.js");
    OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._MODHELP);

    OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
echo "<center><BR><br><h4>"._HELP."</h4><BR><h5>"._MODHELP."</h5>"
  . "<BR>&nbsp;&nbsp;[&nbsp;&nbsp;".  "<a href=\"index.php?func=Module\">Back to XOOPS Module Creator</a>&nbsp;&nbsp;]&nbsp;&nbsp"
  . "<table cellspacing=\"0\" cellPadding=\"0\" width=\"100%\" border=\"0\">"
  . "                              <tr>"
  . "                                <td colSpan=\"2\"><BR><BR>Let's "
  . "                                assume that we have this html code<br>"
  ...
  . "                                    &lt;/head&gt; <br>"
  . "                                    &lt;body&gt; <br>"
  . "                                    &lt;p align=&quot;center&quot;&gt;&lt;font size=&quot;7&quot;&gt;XOOPS "
  . "                                    Web Tools&lt;/font&gt;&lt;/p&gt; <br>"
  . "                                    &lt;p align=&quot;center&quot;&gt;based on PHP-Nuke Tools by&lt;a "
  . "                                    href=&quot;http://www.disipal.net/&quot;&gt;&lt;font "
  . "                                    size=&quot;7&quot;&gt;Disipal site&lt;/font&gt;&lt;/a&gt;&lt;/p&gt; <br>"
  . "                                    &lt;/body&gt; <br>"
  . "                                    &lt;/html&gt; <br>"
  . "                                    <br>"
  . "&nbsp;</font></td>"
  ...
  . "                                xoops module creator top block <br>"
  . "                                <br>"
  ...
  . "                                    size=\\&quot;7\\&quot;&gt;XOOPS Web Tools&lt;/font&gt;&lt;/p&gt;&quot; <br>"
  . "                                    &nbsp; . &quot;&lt;p align=\\&quot;center\\&quot;&gt;based on PHP-Nuke Tools by&lt;a "
  . "                                    href=\\&quot;http://www.disipal.net/\\&quot;&gt;&lt;font "
  . "                                    size=\\&quot;7\\&quot;&gt;Disipal site&lt;/font&gt;&lt;/a&gt;&lt;/p&gt;&quot;; <br>"
  . "                                    CloseTable(); <br>"
  ...
  . "                                XOOPS Module Creator bottom block, and save "
  . "                                it as index.php <br>"
  . "                                <br>"
  ...
  . "                                &nbsp;</font><p>"
  . "                                "
  . "                                <b><font size=\"4\">Note : </font></b>"
  . "                                <p>You need to add the module's information file (xoops_version.php) and create logo for your module, download here <a href=\"xoops_sample_module.zip\">sample module</a> and <a href=\"xoops_admin_icon.zip\">sample admin icon</a>. <br>"
  . "                                <br>"
  . "                                For more details how to build xoops module, please download <a href=\"http://dev.xoops.org/dl/ModuleBuilding.pdf\">ModuleBuilding.pdf</a> and visit <a href=\"http://www.kaotik.biz/tutorial/buildmodule1.html\">Building a simple module</a>.<p>"
  . "                                And you are ready!! <br>"
  . "                                Install the module from"
  . "                                yoursite/modules/system/admin.php?fct=modulesadmin"
  . "                                <br>"
  . "&nbsp;</font></td></tr></table><BR><BR><CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php?func=Module\">Back to XOOPS Module Creator</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
    OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._BLKHELP);

    OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
echo "<center><BR><br><h4>"._HELP."</h4><BR><h5>"._BLKHELP."</h5>"
  . "<BR>&nbsp;&nbsp;[&nbsp;&nbsp;".  "<a href=\"index.php?func=Block\">Back to XOOPS Block Creator</a>&nbsp;&nbsp;]&nbsp;&nbsp"
  . "<table cellspacing=\"0\" cellPadding=\"0\" width=\"100%\" border=\"0\">"
  . "                              <tr>"
  . "                                <td colSpan=\"2\">Let's "
  . "                                assume that we have this html code<br>"
  ...
  . "                                XOOPS Block Creator top block <br>"
  . "                                <br>"
  ...
  . "                                    <br>"
  . "                                    \$block['content'] = &quot;&lt;p align=\\&quot;center\\&quot;&gt;&lt;font "
  . "                                    size=\\&quot;7\\&quot;&gt;PHP-Nuke tools&lt;/font&gt;&lt;/p&gt; &quot;;<br>"
  . "                                    \$block['content'] .= &quot;&lt;p align=\\&quot;center\\&quot;&gt;by&lt;/p&gt; &quot;;<br>"
  . "                                    \$block['content'] .= &quot;&lt;p align=\\&quot;center\\&quot;&gt;&lt;a "
  . "                                    href=\\&quot;http://www.disipal.net/\\&quot;&gt;&lt;font "
  . "                                    size=\\&quot;7\\&quot;&gt;Disipal site&lt;/font&gt;&lt;/a&gt;&lt;/p&gt; &quot;;<br>"
  . "                                    return \$block;<br>"
  . "                                    }<br>"
  ...
  . "                                <p>"
  . "                                <br>"
  . "                                Now open notepad and paste the code generated in the "
  . "                                XOOPS Block Creator bottom block, and "
  . "                                place inside the newly created file whatever_block.php <br>"
  . "                                <br>"
  . "                                Create a folder inside the module folder called “blocks” "
  . "                                and inside copy whatever_block.php <br>"
  . "                                &nbsp;</font><p>"
  ...
  . "                                    <td style='text-align:left'>"
  . "                                    <br>"
  . "                                    \$modversion['blocks'][1]['file'] = &quot;whatever_block.php&quot;; <br>"
  . "                                    \$modversion['blocks'][1]['name'] = &quot;Block Name&quot;; <br>"
  . "                                    \$modversion['blocks'][1]['description'] = &quot;Block Description&quot;; <br>"
  . "                                    \$modversion['blocks'][1]['show_func'] = &quot;whatever_show&quot;; <br>"
  . "&nbsp;</font></td>"
  . "                                  </tr>"
  . "                                </table>"
  . "                                <br>"
  ...
  . "                                hyoursite.modules/system/admin.php?fct=blocksadmin<br>"
  . "&nbsp;</font></td>"
  . "                              </tr>"
  . "                            </table><BR><BR><CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php?func=Block\">Back to XOOPS Block Creator</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
    OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
    CloseTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HTMLSWS);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/HTMLSWS.js");
        OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._EMAILCODER);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/emailencoder.js");
       OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
echo " <TABLE  cellspacing=0 cellPadding=0 width=\"100%\" border=0>"
  ...
  . ""._EMAILI."<I><A title=\"Go to this site for a detailed explanation of Character Entities\" href=\"http://www.w3.org/TR/REC-html32\" target=_blank>Character Entities</A></I>"._EMAILII.""
  . "<TR></TR></TABLE></TABLE>";
    CloseTable();
    OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._ROTCODER);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/rot.js");
       OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._URLCODER);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/URLCODER.js");
       OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._PREVIEWER);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/PREVIEWER.js");
       OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HTMLCODER);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/HTMLENCODER.js");
        OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
echo " <TABLE  cellspacing=0 cellPadding=0 width=\"100%\" border=0>"
  ...
  . "        <TR>"
  . "          <TD align=\"center\" width=\"662\"><INPUT onclick=encode(document.form1.text1.value) type=button value="._CON."> "
  . "            <INPUT id=RCinput type=checkbox value=1 name=mgsbrd>"._CFF." &nbsp;&nbsp;<INPUT "
  . "onclick=selectCode(document.form1.text1) type=button  value="._SELEC.">&nbsp;<INPUT onclick=Cleartxt(document.form1.text1) type=button "
  . "value=Clear></TD></TR>"
  . "        <TR>"
  . "          <TD width=\"662\" align=\"center\">"
  . "          <TEXTAREA name=encoded_txt rows=12 cols=51></TEXTAREA></TD></TR>"
  . "        <TR>"
  . "          <TD align=\"center\" width=\"662\"><INPUT onclick=preview() type=button value="._PREVIEWR."> &nbsp;&nbsp;<INPUT onclick=selectCode(document.form1.encoded_txt) type=button value="._SELEC.">&nbsp;<INPUT onclick=Cleartxt(document.form1.encoded_txt) type=button value="._CLEAR."> "
  . "          <p>"._HTMLEP."</TD></TR></TABLE></FORM>"
  . "</TD></TR></TABLE>"
  . "</TD></TR></TABLE>";
    CloseTable();
...
global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._SCODER);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/SourceCoder.js");
OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
    CloseTable();
    OpenTable();
echo " <TABLE  cellspacing=0 cellPadding=0 width=\"100%\" border=0>"
  ...
  . "              <p align=\"center\"><TEXTAREA style=\"WIDTH: 80%; BACKGROUND-COLOR: #\" name=text rows=11 cols=58></TEXTAREA><BR><INPUT onmouseover=LightOn(this) onclick=generate() onmouseout=LightOut(this) type=button value="._ENCODE." name=compileIt> "
  . "<INPUT onmouseover=LightOn(this) onclick=selectCode() onmouseout=LightOut(this) type=button value="._SELEC." name=select> "
  . "<INPUT onmouseover=LightOn(this) onclick=preview() onmouseout=LightOut(this) type=button value="._PREVIEWR." name=view> "
  . "<INPUT onmouseover=LightOn(this) onclick=uncompile() onmouseout=LightOut(this) type=button value="._DECODE." name=retur> "
  . "<INPUT onmouseover=LightOn(this) onmouseout=LightOut(this) type=reset value="._CLEAR." name=clear>"
  . "              </p>"
  . "            </FORM><!-- Compilation Panel --></TD></TR></TABLE><!--webbot bot=\"HTMLMarkup\" endspan -->"
  . "</TD></TR></TABLE>"
  . "</TD></TR></TABLE>";
    CloseTable();
...
// De Duper is from T-tech tools module
function DeDupe() {

global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._DEDUPER);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/TechDeDupe.js");
OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
CloseTable();
OpenTable();
...
// based on hexvalues module by www.spacedesign.nu
function ColorMatch() {

global $xoopsTheme, $xoopsModule, $xoopsTpl;
$xoopsTpl->assign('xoops_pagetitle', $xoopsModule->getVar('name'). ' - ' ._HEXV);

include(XOOPS_ROOT_PATH."/modules/" . $xoopsModule->dirname() . "/js/AC_RunActiveContent.js");
OpenTable();
echo "<div align='center'><a href=\"index.php\"><img src=\"".XOOPS_URL."/modules/" . $xoopsModule->dirname() . "/images/tools.jpg\" alt=\"".$xoopsModule->getVar("name")."\" /></a></div>";
CloseTable();
OpenTable();
...
<noscript><object classid='clsid:d27cdb6e-ae6d-11cf-96b8-444553540000' codebase='http://download.macromedia.com/pub/shockwave/cabs/flash/swflash.cab#version=9,0,0,0' width='600' height='450' id='hexvalues' align='middle'>
	<param name='allowScriptAccess' value='sameDomain' /><param name='allowFullScreen' value='false' />
	<param name='movie' value='hexvalues.swf' /><param name='quality' value='high' /><param name='bgcolor' value='#ffffff' />	<embed src='hexvalues.swf' quality='high' bgcolor='#ffffff' width='600' height='450' name='hexvalues' align='middle' allowScriptAccess='sameDomain' allowFullScreen='false' type='application/x-shockwave-flash' pluginspage='http://www.macromedia.com/go/getflashplayer' />
</object></noscript>";
    CloseTable();
        OpenTable();
   echo"    <CENTER>&nbsp;&nbsp;[&nbsp;&nbsp;<a href=\"index.php\">"._BACK."</a>&nbsp;&nbsp;]&nbsp;&nbsp";
...
// catzwolf_ fix
$func = ( isset( $_GET['func'] ) AND preg_match( '/^[a-zA-Z0-9_\.\-`]*$/', $_GET['func'] ) ) ? strval( $_GET['func'] ) : '';
//
