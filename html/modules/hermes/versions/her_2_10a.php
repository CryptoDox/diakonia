 ...
 ************************************************************/
  ...
  var $description  = 'Test version 2.10a';

/************************************************************
 * Constructucteur:
 ************************************************************/
  function  cls_her_2_10a($options){
...
global $xoopsModuleConfig, $xoopsDB;
  ...
  $sql = "ALTER TABLE {$table}"
        ." ADD bgImgMode     tinyint(4) unsigned ,"      
        ." ADD bgImgRepeat   tinyint(4) unsigned ,"
        ." ADD bgImgPosH     tinyint(4) unsigned ,"
        ." ADD bgImgPosV     tinyint(4) unsigned ";
