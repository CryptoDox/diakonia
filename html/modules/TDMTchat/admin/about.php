...
Adminmenu(2, _AM_TDMTCHAT_MANAGE_ABOUT);
} else {
include_once XOOPS_ROOT_PATH.'/Frameworks/art/functions.admin.php';
loadModuleAdminMenu (2, _AM_TDMTCHAT_MANAGE_ABOUT);
}
...
<h3><strong>'._AM_TDMTCHAT_MANAGE_ABOUT.'</strong></h3>';
echo '</div><br />';
...
$file = XOOPS_ROOT_PATH. "/modules/TDMTchat/changelog.txt";
if ( is_readable( $file ) ){
