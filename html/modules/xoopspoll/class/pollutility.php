 ...
 * @subpackage:: class
 * @since::      1.40
 * @version::    $Id: pollutility.php 12482 2014-04-25 12:08:17Z beckmi $
 * @access::     public
 */
...
class XoopspollPollUtility
{
     ...
     */
    static public function getHostByAddrWithCache(&$ipAddr)
    {
     ...
     * @static
     */
    static public function commentMode()
    {
        static $mConfig;
        if (!isset($mConfig)) {
     ...
     */
    static public function getVisibilityArray()
    {
        /**
     ...
     */
    static public function getVoteCookie($cookieBaseName='voted_polls')
    {
        $pollDir = basename(dirname(dirname(__FILE__)));
     ...
     */
    static public function setVoteCookie($index, $value, $expires=0, $cookieBaseName='voted_polls')
    {
        $pollDir = basename(dirname(dirname(__FILE__)));
        $success = false;
     ...
     * @return bool         success in setting cookie
     */
    static public function dbTableExists(&$db, $tablename)
    {
