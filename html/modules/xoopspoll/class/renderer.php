 ...
 * @version::    $Id: renderer.php 12482 2014-04-25 12:08:17Z beckmi $
 */
...
class XoopspollRenderer
{
    ...
    public function renderForm()
    {
        ...
        return $myTpl->fetch($GLOBALS['xoops']->path('modules' . DIRECTORY_SEPARATOR
...
*/
    ...
    public function renderResults()
    {
        ...
        return $myTpl->fetch($GLOBALS['xoops']->path('modules' . DIRECTORY_SEPARATOR
                                                   . 'xoopspoll' . DIRECTORY_SEPARATOR
                                                   . 'templates' . DIRECTORY_SEPARATOR
                                                                 . 'xoopspoll_results_renderer.tpl')
        );
    }
