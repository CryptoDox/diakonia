...
*/
/**
 * Reply Comments for the XoopsPoll Module
 *
 ...
 * @version::    $Id: comment_reply.php 12482 2014-04-25 12:08:17Z beckmi $
 *
 * @uses $GLOBALS['xoops']::path gets XOOPS directory information
 */
include '..'. DIRECTORY_SEPARATOR . '..' . DIRECTORY_SEPARATOR . 'mainfile.php';
include $GLOBALS['xoops']->path('include' . DIRECTORY_SEPARATOR . 'comment_reply.php');
