...
define("_MB_SHOUTBOX_SHOUT","Envoyer");
define("_MB_SHOUTBOX_CLEAR","Tout effacer");
define("_MB_SHOUTBOX_BBCODEON","BBcode=on");
define("_MB_SHOUTBOX_BBCODEOFF","BBcode=off");
define("_MB_SHOUTBOX_AUTOREFRESH","Activer le rafraîchissement auto");
define("_MB_SHOUTBOX_REFRESH", "Rafraîchir");
define("_MB_SHOUTBOX_POPUP", "Ouvrir le tchat dans un popup");

define("_MB_SHOUTBOX_SHOUT_TITLE", "Votre Message");
define("_MB_SHOUTBOX_NICK", "Pseudo");

define("_MB_SHOUTBOX_CONFIRMDEL", "Etes-vous sûr de vouloir effacer tous les messages de la base de données / du fichier ?");
?>