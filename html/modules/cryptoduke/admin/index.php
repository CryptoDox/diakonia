...
CryptoDuke_adminmenu(0, _AM_CRYPTODUKE_MANAGER_INDEX);
} else {
include_once XOOPS_ROOT_PATH.'/Frameworks/art/functions.admin.php';
loadModuleAdminMenu (0, _AM_CRYPTODUKE_MANAGER_INDEX);
}

include_once XOOPS_ROOT_PATH.'/modules/'.$xoopsModule->dirname().'/class/menu.php';

				$menu = new CryptoDukeMenu();
				$menu->addItem('modules', 'modules.php', '../images/deco/modules.png', _AM_CRYPTODUKE_MANAGER_MODULES);
				//$menu->addItem('tables', 'tables.php', '../images/deco/tables.png',  _AM_CRYPTODUKE_MANAGER_TABLES);
				//$menu->addItem('const', 'const.php', '../images/deco/const.png',  _AM_CRYPTODUKE_MANAGER_CONST);
				$menu->addItem('about', 'about.php', '../images/deco/about.png',  _AM_CRYPTODUKE_MANAGER_ABOUT);
				$menu->addItem('update', '../../system/admin.php?fct=modulesadmin&op=update&module='.$xoopsModule ->getVar('name')
												, '../images/deco/update.png',  _AM_CRYPTODUKE_MANAGER_UPDATE);	
				/*$menu->addItem('Preference', '../../system/admin.php?fct=preferences&amp;op=showmod&amp;mod='.$xoopsModule ->getVar('mid').
												'&amp;&confcat_id=1', '../images/deco/pref.png',  _AM_CRYPTODUKE_MANAGER_PREFERENCES);	*/
...
echo '<div class="CPbigTitle" style="background-image: url(../images/deco/index.png); background-repeat: no-repeat; background-position: left; padding-left: 60px; height: 48px;">
		<strong>'._AM_CRYPTODUKE_MANAGER_INDEX.'</strong>
