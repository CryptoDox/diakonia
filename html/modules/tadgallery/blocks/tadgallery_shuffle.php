...
// 本模組由 tad 製作
// 製作日期：2008-03-23
// $Id: tadgallery_shuffle.php,v 1.7 2008/05/14 01:23:14 tad Exp $
// ------------------------------------------------------------------------- //
...
function tadgallery_shuffle_show($options){
	...
	while(list($sn,$title,$description,$filename,$dir)=$xoopsDB->fetchRow($result)){
	  $pic_url=get_pic_url($dir,$sn,$filename,$options[4]);
		$pic.="<li style='list-style-type: none;'><span><img src='$pic_url' alt='$title' /></span></li>";
	}


	$block="
	<script type='text/javascript' src='".XOOPS_URL."/modules/tadgallery/class/jqshuffle.js'></script>
	...
	<ul class='imageBox' style='list-style-type: none;'>
	$pic
	</ul>
	</div>";
	return $block;
