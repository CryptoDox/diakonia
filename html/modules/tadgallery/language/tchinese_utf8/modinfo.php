...
define("_MI_TADGAL_ADMENU3", "精華圖片管理");
define("_MI_TADGAL_ADMENU4", "模組更新");
define("_MI_TADGAL_ADMENU5", "產生 Media RSS");
define("_MI_TADGAL_ADMENU6", "批次管理");
define("_MI_TADGAL_TEMPLATE_DESC1", "電子相簿的樣板檔。");
define("_MI_TADGAL_TEMPLATE_DESC2", "單一相片的樣板檔。");
define("_MI_TADGAL_TEMPLATE_DESC3", "投影片秀的樣板檔。");
define("_MI_TADGAL_TEMPLATE_DESC4", "上傳者相簿的樣板檔。");
define("_MI_TADGAL_TEMPLATE_DESC5", "電子相簿的樣板檔。");
...
define("_MI_TADGAL_BNAME4","引入jquery的區塊");
define("_MI_TADGAL_BDESC4","用來引入圖形特效的區塊");
...
define("_MI_TADGAL_ALLOW_HOTLINKING_DESC","開啟防盜連後，若要開放某個網站連結本站相簿圖片，請在此輸入網址。<br />如：「http://tad.tnc.edu.tw」，最後請勿輸入「/」，若有多個網站，請以「;」隔開。");

define("_MI_TADGAL_SHOW_COPY_PIC","<b>顯示快速複製按鈕</b>");
