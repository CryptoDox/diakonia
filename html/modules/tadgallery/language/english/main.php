...
define("_BP_GO_BACK_PAGE","Go back %s pages");
...
define("_TADGAL_FILE_COPY_S","Copy URL to small thumbnail");
define("_TADGAL_FILE_COPY_M","Copy URL to medium thumbnail");
define("_TADGAL_FILE_COPY_B","Copy URL to original photo");
