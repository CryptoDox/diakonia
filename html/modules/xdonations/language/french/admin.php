...
define ('_AD_DON_ADD_ANYWAY',                     'Ajouter un utilisateur au groupe / Classement si don anonyme');
...
define ('_AD_DON_CLEAR_LOG',                      'Effacer le journal');
define ('_AD_DON_CLEAR_THIS_LOG',                 'Etes-vous s&#251;r de vouloir supprimer le journal des transactions?');
define ('_AD_DON_CONFIG_PAYPAL_HEADER',           'Configuration de paypal');
...
define ('_AD_DON_CURRENT',                        'Actuellement');
define ('_AD_DON_CUST_ID',                        'Personnaliser  de paypal :');
define ('_AD_DON_CUST_NAME',                      'Personnaliser:');
...
define ('_AD_DON_ERR_BAD_DATE_FORMAT',            'Format de date incorrecte');
define ('_AD_DON_ERR_BAD_NAME_FORMAT',            'Le champ Nom ne peut pas &#234;tre vide');
define ('_AD_DON_ERR_DB_INSERTION',               '<span style="font-weight: bold; color: red;"> ERREUR :</span> '
                                                 .'Il y a %d &#224; importer<br />'
                                                 .'Erreur lors de l/insertion '
                                                 .'table.<br />Insertion <span style="font-weight: bold; color: red;">interronpue</span>');
define ('_AD_DON_ERR_INVALID_RECORD_ID',          'Enregistrement invalide, op&#233;ration annul&#233;e');
define ('_AD_DON_ERR_SQL_FAILURE',                'Si vous voyez cet &#233;cran '
                                                 .'<span style="color: #FF0000;">une erreur SQL a &#233;t&#233; rencontr&#233;e</span><br />'
                                                 .'Vous devriez voir un message en <span style="color: #FF0000;">RED</span> ci-dessous '
                                                 .'la condition d/erreur</span>');
...
define ('_AD_DON_GROSS',                          'Montant brut');
...
define ('_AD_DON_ITEM_INFO',                      'Point Info');
define ('_AD_DON_LOG_CLEARED',                    'IPN Connectez-vous');
define ('_AD_DON_LOG_DATE',                       'Date de connexion: ');
define ('_AD_DON_LOG_EMPTY',                      'Il n&apos;y a pas de journal de transaction IPN  dans la base de donn&#233;es');
...
define ('_AD_DON_NEXT_NEWEST',                    'Le plus r&#233;cent');
define ('_AD_DON_NEXT_OLDEST',                    'Les plus anciens');
define ('_AD_DON_NO_NEW_IPNS',                    'Il y a un IPN a importer! ');
...
define ('_AD_DON_OLDEST',                         'Les plus anciens');
define ('_AD_DON_PMNT_DATE',                      'Date de payement : ');
define ('_AD_DON_PMNT_TYPE',                      'Type de payement: ');
...
define ('_AD_DON_PP_MONEY',                       'Choisissez votre monnaie');
...
define ('_AD_DON_SEARCH_FORM',                    'Rechercher par transaction ID');
define ('_AD_DON_SEARCH_TERM',                    'Recherchercher par:');
...
define ('_AD_DON_T_don_forceadd_',                'Ajouter l&apos;utilisateur au groupe / rang m&#234;me si l&apos;utilisateur choisit de rester anonyme');
...
define ('_MI_DON_T_don_text_rawtext',             'Nous sommes une organisation complétement supportée par vous, les membres.'.'<br />'
.'De nombreuses organisations ont des sites Web, des serveurs et la largeur de bande Internet offertes par ses membres.'.'<br />'
.'Nous sommes fiers d&apos;être  soutenu par une communauté de  membres.'.'<br />'
.'Cela signifie que nous avons besoin de vous, pour faire partie de cette communauté. Nous encourageons chaque membre à contribuer à la collectivité à hauteur de leur moyen.'.'<br />'
.'Nous devons payer nos factures chaque mois pour maintenir le site et les productions en cours.'.'<br />'
.'Pour ceux d&apos;entre vous qui peuvent, nous vous demandons de faire une contribution financière, quelle qu&apos;en soit la valeur, chaque don compte.'.'<br />'
...
.'paiement. Vous devez utiliser cette fonctionnalit&eacute; si vous avez rempli un &quot;MERCI&quot; URL.'.'<br />'
