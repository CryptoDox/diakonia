...
if ( empty($forum) ) {
	...
	$sql = sprintf("SELECT forum_type, forum_name, forum_access, allow_html, allow_sig, posts_per_page, hot_threshold, topics_per_page, allow_upload FROM %s WHERE forum_id = %u", $xoopsDB->prefix('bbex_forums'), $forum);
