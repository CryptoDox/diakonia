<?php
// $Id: admin.php 1112 2010-01-28 18:27:34Z kris_fr $
// _LANGCODE: en
// _CHARSET : UTF-8
...
define("_PROFILE_AM_FIELDNOTCONFIGURABLE", "Ce champ ne peut configuré");

define("_PROFILE_AM_ADD", "Ajouter %s");
define("_PROFILE_AM_EDIT", "Editer %s");
define("_PROFILE_AM_TYPE", "Type de champs");
...
define("_PROFILE_AM_FIELDVISIBLETOALL", "- Tous les membres");
...
define("_PROFILE_AM_LANGUAGE", "Sélection du language");
define("_PROFILE_AM_RADIO", "Bouton radio");
define("_PROFILE_AM_SELECT", "Sélection");
define("_PROFILE_AM_SELECTMULTI", "Multi-sélection");
...
define("_PROFILE_MA_USERLEVEL", "Statut utilisateur");
...
define("_PROFILE_AM_USER_NOT_ACTIVATED", "Erreur! L'utilisateur non activé");
define("_PROFILE_AM_USER_NOT_DEACTIVATED", "Erreur! L'utilisateur non désactivé");
 ...
 *
 * @version         $Id: admin.php 1112 2010-01-28 18:27:34Z kris_fr $
**/
?>